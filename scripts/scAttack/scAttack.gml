...
function glorbo_attack(){
    if (can_attack && key_attack) {
		...
		_attack_instance1.horizontal_speed = 9 * attack_direction;
		...
		_attack_instance2.horizontal_speed = 9 * attack_direction;
		_attack_instance2.direction = attack_direction;
		_attack_instance2.image_xscale = (attack_direction == 1) ? -1 : 1;
		...
		_attack_instance3.horizontal_speed = 9 * attack_direction;
		...
		_attack_instance4.horizontal_speed = 9 * attack_direction;
