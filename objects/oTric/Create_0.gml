...
attack_cooldown = 2.35 * game_get_speed(gamespeed_fps);
...
TRIC_WINDUP_TIME = 65;       // Wind-up duration in frames (30 = half a second at 60fps)
TRIC_SHOTS_PER_BARRAGE = 15; // The number of bullets to fire
TRIC_SHOT_INTERVAL = 2.1;      // Frames between each shot in the barrage
TRIC_RECOIL_STRENGTH = 12.0;  // How hard the gun pushes you back
